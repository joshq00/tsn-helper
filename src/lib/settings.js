...
var settings_defaults = {
    ...
    "warmness": 30,
    "coolness": 10,
    "superSecret": "ithankedryan",
    "superSecretMd5": "2c3005677d594560df2a9724442428d1",
...
function initSchema() {
    ...
    schema = {
        ...
        "properties": {
            "smartInterval": {
                "type": "integer",
                "title": "Refresh Smart Buy/Sell Interval (seconds)",
                "description": "Number of seconds between card info refreshes.",
                "default": 15,
                "required": true
            },
            "refreshInterval": {
